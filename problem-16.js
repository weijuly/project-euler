...
var canHandle = Math.pow(2, 32).toString();
var result = '1';
for (var i = 0; i < 31; i++) {
    result = multiply(result, canHandle);
}
var remain = Math.pow(2, 8).toString();
result = multiply(result, remain);
console.log('result: ' + digitSum(result));
